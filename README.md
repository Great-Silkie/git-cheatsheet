...
Сообщение к коммитам необходимо, чтобы быстро отличить одно изменение от другого

Общие рекомендации к сообщениям:
...
Здесь есть:
1. указание изменения
2. указание места изменения
3. указание для сужения группы заинтересованных

Стили оформления:
1. Корпоративный - с указанием в начале кода Jira ID
2. Сщтмутешщтыд Сщььшеы - с указанием типа изменения (Feat - новая функциональность, fix - исправление ошибки, и т.д.)
3. GitHub стиль - с указанием в произвольном месте сообщения номера задачи в GitHub

В русском языке принято использовать инфинитив:

*Добавить* тесты ..., *Исправить*...

В английском языке принято использовать повелительное наклонение:

*Use* library ..., *Fix* exit button